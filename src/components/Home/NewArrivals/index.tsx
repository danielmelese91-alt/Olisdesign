...
const NewArrival = ({ products }: { products: Product[] }) => {
  // Show placeholder when no products are tagged as signature arrivals
        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="mb-7 flex items-center justify-between">
            <div>
              ...
              <h2 className="font-semibold text-xl xl:text-heading-5 text-dark font-serif-display">
                Signature Arrivals
              </h2>
            </div>
          </div>
          <div className="text-center py-12 bg-gray-1 rounded-lg">
            <p className="text-gray-500">
              No products tagged as Signature Arrivals yet.
            </p>
            <p className="text-sm text-gray-400 mt-2">
              Go to Studio → Products and enable "Signature Arrival" to display them here.
            </p>
          </div>
        </div>
      </section>
